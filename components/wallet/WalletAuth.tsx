    ...
    return (
      <div className={`p-6 border-4 border-dark bg-card ${className}`}>
        ...
        {showUsernameSetup ? (
          ...
          <p className="mt-4 text-sm text-dark/50">Redirecting to dashboard...</p>
        )}
      </div>
    );
  }
  ...
  return (
    <div className={`p-6 border-4 border-dark bg-card ${className}`}>
      <div className="flex flex-col items-center text-center mb-6">
        ...
        <h2 className="text-xl font-black text-dark mb-2">Connect Wallet</h2>
      ...
      <p className="mt-4 text-xs text-dark/50 text-center">
